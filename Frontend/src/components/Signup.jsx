...
const Login = () => {
  ...
  return (
    <div > 
        ...
        src={Image}
        alt="Illustration"
        className="absolute top-0 left-0 w-[105%] blur-[2px] h-full object-cover brightness-70"
        />

        <div className="flex min-h-[calc(100vh-180px)]  relative justify-end w-[calc(100%-160px)] mx-[30px] mt-25 rounded-xl">
  {/* Left Illustration */}
  <img
    src={Image1}
    alt="Illustration"
  ...
  {/* Right Login Form */}
  <div
    className="flex justify-center items-center p-4 bg-[#003501] rounded-l-[2.5rem] relative z-10 w-[38%] md:w-[33%] min-h-[105%]"
  ...
  >
    <div className="w-full max-w-sm">
      ...
      <div className="text-center">
        <h2 className="text-xl md:text-xl text-white font-semibold">Welcome to YegnaFarm!</h2>
      </div>
      ...
      <form className="flex flex-col gap-4 p-6">
        <input
          ...
          className="w-full border-b border-white pb-1.5 focus:outline-none text-base text-white"
        />
        <input
          required
          type="email"
